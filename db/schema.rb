...
ActiveRecord::Schema[7.0].define(version: 2024_02_08_132037) do
  ...
  create_table "middle_earth_users", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_middle_earth_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_middle_earth_users_on_reset_password_token", unique: true
  end
